...
<div class="sidebar" id="sidebar">
				...
				<div class="call-box outgoing-box">
					<div class="call-wrapper">
						<div class="call-inner">
							<div class="call-user">
								<img alt="" src="<?php echo e(asset('img/profiles/avatar-02.jpg')); ?>" class="call-avatar">
								<h4>John Doe</h4>
		...
		<?php /**PATH /home/nxgbxuzv/crm.nxgbs.com/resources/views/admin/apps/calls/outgoing-call.blade.php ENDPATH**/ ?>