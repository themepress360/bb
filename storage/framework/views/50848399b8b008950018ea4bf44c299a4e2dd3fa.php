...
<div class="sidebar" id="sidebar">
                <div class="sidebar-inner slimscroll">
					<div class="sidebar-menu">
						<ul>
							<li> 
								<a href="<?php echo e(url('/employee/dashboard')); ?>"><i class="la la-home"></i> <span>Back to Home</span></a>
							</li>
										...
										<div class="user-details mr-auto">
											<div class="float-left user-img">
												<a class="avatar" href="profile" title="Mike Litorus">
													<img src="<?php echo e(asset('img/profiles/avatar-05.jpg')); ?>" alt="" class="rounded-circle">
...
<?php echo $__env->make('layout.employeelayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nxgbxuzv/crm.nxgbs.com/resources/views/employees/apps/chat/index.blade.php ENDPATH**/ ?>