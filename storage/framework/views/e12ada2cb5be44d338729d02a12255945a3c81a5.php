<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
								...
								<div class="chat-contents">
									<div class="chat-content-wrap">
										<div class="voice-call-avatar">
											<img src="<?php echo e(asset('img/profiles/avatar-02.jpg')); ?>" alt="" class="call-avatar">
										...
										<div class="call-users">
											<ul>
												<li>
													<a href="#">
														<img src="<?php echo e(asset('img/profiles/avatar-03.jpg')); ?>" class="img-fluid" alt="">
														<span class="call-mute"><i class="fa fa-microphone-slash"></i></span>
													</a>
												</li>
												<li>
													<a href="#">
														<img src="<?php echo e(asset('img/profiles/avatar-08.jpg')); ?>" class="img-fluid" alt="">
														<span class="call-mute"><i class="fa fa-microphone-slash"></i></span>
													</a>
												</li>
												<li>
													<a href="#">
														<img src="<?php echo e(asset('img/profiles/avatar-05.jpg')); ?>" class="img-fluid" alt="">
														<span class="call-mute"><i class="fa fa-microphone-slash"></i></span>
													</a>
												</li>
											</ul>
													...
													<div class="chat chat-left">
														<div class="chat-avatar">
															<a href="profile" class="avatar">
																<img alt="John Doe" src="<?php echo e(asset('img/profiles/avatar-02.jpg')); ?>">
															</a>
														</div>
														<div class="chat-body">
																			...
																			<div class="chat-content">
																				...
																				<ul class="attach-list">
																					<li class="img-file">
																						...
																						<div class="task-attach-img"><img src="<?php echo e(asset('img/user.jpg')); ?>" alt=""></div>
																					</li>
																				</ul>
																			</div>
																		</div>
													...
													<div class="table-content">
														<div class="chat-profile-img">
															<div class="edit-profile-img">
																<img src="<?php echo e(asset('img/profiles/avatar-02.jpg')); ?>" alt="">
		...
		<?php /**PATH /home/nxgbxuzv/crm.nxgbs.com/resources/views/admin/apps/calls/voice-call.blade.php ENDPATH**/ ?>