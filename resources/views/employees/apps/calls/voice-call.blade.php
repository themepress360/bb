								...
								<div class="chat-contents">
									<div class="chat-content-wrap">
										<div class="voice-call-avatar">
											<img src="{{asset('img/profiles/avatar-02.jpg')}}" alt="" class="call-avatar">
										...
										<div class="call-users">
											<ul>
												<li>
													<a href="#">
														<img src="{{asset('img/profiles/avatar-03.jpg')}}" class="img-fluid" alt="">
														<span class="call-mute"><i class="fa fa-microphone-slash"></i></span>
													</a>
												</li>
												<li>
													<a href="#">
														<img src="{{asset('img/profiles/avatar-08.jpg')}}" class="img-fluid" alt="">
														<span class="call-mute"><i class="fa fa-microphone-slash"></i></span>
													</a>
												</li>
												<li>
													<a href="#">
														<img src="{{asset('img/profiles/avatar-05.jpg')}}" class="img-fluid" alt="">
														<span class="call-mute"><i class="fa fa-microphone-slash"></i></span>
													</a>
												</li>
											</ul>
													...
													<div class="chat chat-left">
														<div class="chat-avatar">
															<a href="profile" class="avatar">
																<img alt="John Doe" src="{{asset('img/profiles/avatar-02.jpg')}}">
															</a>
														</div>
														<div class="chat-body">
																			...
																			<div class="chat-content">
																				...
																				<ul class="attach-list">
																					<li class="img-file">
																						...
																						<div class="task-attach-img"><img src="{{asset('img/user.jpg')}}" alt=""></div>
																					</li>
																				</ul>
																			</div>
																		</div>
